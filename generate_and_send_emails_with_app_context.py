...
from app import app, db, Resume, Posting, UserEmail, Recruiter
...
def main():
    ...
    with app.app_context():
        ...
        resumes = Resume.query.order_by(Resume.id).limit(2).all()
        postings = Posting.query.order_by(Posting.id).limit(2).all()
